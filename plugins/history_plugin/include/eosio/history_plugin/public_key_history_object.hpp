...
CHAINBASE_SET_INDEX_TYPE( ETAio::public_key_history_object, ETAio::public_key_history_multi_index )

FC_REFLECT( ETAio::public_key_history_object, (public_key)(name)(permission) )
