...
/**
 * @brief ETAIO Public Key
 * @details ETAIO Public Key. It is 34 bytes.
 */
struct public_key {
   char data[34];
};
...
/**
 * @brief ETAIO Signature
 * @details ETAIO Signature. It is 66 bytes.
 */
struct signature {
   uint8_t data[66];
};
...
/**
 * @brief Type of ETAIO Transaction Id
 * @details Type of ETAIO Transaction Id. It is 256-bit hash
 */
