...
FC_REFLECT( ETAio::chain::type_def                         , (new_type_name)(type) )
FC_REFLECT( ETAio::chain::field_def                        , (name)(type) )
FC_REFLECT( ETAio::chain::struct_def                       , (name)(base)(fields) )
FC_REFLECT( ETAio::chain::action_def                       , (name)(type)(ricardian_contract) )
FC_REFLECT( ETAio::chain::table_def                        , (name)(index_type)(key_names)(key_types)(type) )
FC_REFLECT( ETAio::chain::clause_pair                      , (id)(body) )
FC_REFLECT( ETAio::chain::error_message                    , (error_code)(error_msg) )
FC_REFLECT( ETAio::chain::abi_def                          , (version)(types)(structs)(actions)(tables)
