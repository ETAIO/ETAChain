...
FC_REFLECT( ETAio::chain::transaction_header, (expiration)(ref_block_num)(ref_block_prefix)
                                              (max_net_usage_words)(max_cpu_usage_ms)(delay_sec) )
FC_REFLECT_DERIVED( ETAio::chain::transaction, (ETAio::chain::transaction_header), (context_free_actions)(actions)(transaction_extensions) )
FC_REFLECT_DERIVED( ETAio::chain::signed_transaction, (ETAio::chain::transaction), (signatures)(context_free_data) )
FC_REFLECT_ENUM( ETAio::chain::packed_transaction::compression_type, (none)(zlib))
FC_REFLECT( ETAio::chain::packed_transaction, (signatures)(compression)(packed_context_free_data)(packed_trx) )
FC_REFLECT_DERIVED( ETAio::chain::deferred_transaction, (ETAio::chain::signed_transaction), (sender_id)(sender)(payer)(execute_after) )
FC_REFLECT( ETAio::chain::deferred_reference, (sender)(sender_id) )
