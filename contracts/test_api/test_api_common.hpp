...
#ifdef DISABLE_ETALIB_SERIALIZE
#include <ETAiolib/serialize.hpp>
#undef ETALIB_SERIALIZE
#define ETALIB_SERIALIZE(...)
#endif
...
struct u128_action {
  ...
  ETALIB_SERIALIZE( u128_action, (values) )
};
...
struct cf_action {
   ...
   ETALIB_SERIALIZE( cf_action, (payload)(cfd_idx) )
};
...
struct dtt_action {
   ...
   ETALIB_SERIALIZE( dtt_action, (payer)(deferred_account)(deferred_action)(permission_name)(delay_sec) )
};
...
struct invalid_access_action {
   ...
   ETALIB_SERIALIZE( invalid_access_action, (code)(val)(index)(store) )
};
