...
using action_name    = ETAio::chain::action_name;
...
FC_REFLECT( ETAio::chain::newaccount                       , (creator)(name)(owner)(active) )
FC_REFLECT( ETAio::chain::setcode                          , (account)(vmtype)(vmversion)(code) )
FC_REFLECT( ETAio::chain::setabi                           , (account)(abi) )
FC_REFLECT( ETAio::chain::updateauth                       , (account)(permission)(parent)(auth) )
FC_REFLECT( ETAio::chain::deleteauth                       , (account)(permission) )
FC_REFLECT( ETAio::chain::linkauth                         , (account)(code)(type)(requirement) )
FC_REFLECT( ETAio::chain::unlinkauth                       , (account)(code)(type) )
FC_REFLECT( ETAio::chain::canceldelay                      , (canceling_auth)(trx_id) )
FC_REFLECT( ETAio::chain::onerror                          , (sender_id)(sent_trx) )
