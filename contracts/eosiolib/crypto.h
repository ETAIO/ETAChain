 ...
 *  ETAio::print("sha256 hash generated from data equals provided hash");
 *  @endcode
 */
 ...
 *  ETAio::print("sha1 hash generated from data equals provided hash");
 *  @endcode
 */
 ...
 *  ETAio::print("sha512 hash generated from data equals provided hash");
 *  @endcode
 */
 ...
 *  ETAio::print("ripemod160 hash generated from data equals provided hash");
 *  @endcode
 */
 ...
 *  ETA_assert( calc_hash == hash, "invalid hash" );
 *  @endcode
 */
 ...
 *  ETAio::print("pub key matches the pub key generated from digest");
 *  @endcode
 */
