 ...
 * @ingroup types
 * @brief Defines contract type which is %base class for every ETAIO contract
 * 
 * @{
 * 
 */
...
/**
 * @brief %Base class for ETAIO contract.
 * @details %Base class for ETAIO contract. %A new contract should derive from this class, so it can make use of ETAIO_ABI macro.
 */
class contract {
   public:
      /**
