...
#include <ETAio/chain/incremental_merkle.hpp>
...
CHAINBASE_SET_INDEX_TYPE(ETAio::chain::global_property_object, ETAio::chain::global_property_multi_index)
CHAINBASE_SET_INDEX_TYPE(ETAio::chain::dynamic_global_property_object,
                         ETAio::chain::dynamic_global_property_multi_index)

FC_REFLECT(ETAio::chain::dynamic_global_property_object,
           (global_action_sequence)
          )

FC_REFLECT(ETAio::chain::global_property_object,
