...
FC_REFLECT(ETAio::chain::permission_level_weight, (permission)(weight) )
FC_REFLECT(ETAio::chain::key_weight, (key)(weight) )
FC_REFLECT(ETAio::chain::wait_weight, (wait_sec)(weight) )
FC_REFLECT(ETAio::chain::authority, (threshold)(keys)(accounts)(waits) )
FC_REFLECT(ETAio::chain::shared_authority, (threshold)(keys)(accounts)(waits) )
