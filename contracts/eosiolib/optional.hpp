   ...
   class optional {
      public:
         ...
         */
          ...
          */
         T&       operator*()      { ETAio_assert(_valid, "dereference of empty optional"); return ref(); }
          ...
          * @return T& - Contained value
          */
         const T& operator*()const { ETAio_assert(_valid, "dereference of empty optional"); return ref(); }
         ...
         T*       operator->()
         {
            ETAio_assert(_valid, "dereference of empty optional");
            return ptr();
         }
         ...
         *  @return ETAio::datastream<Stream>& - Reference to the datastream
         */
         template<typename Stream>
         friend inline ETAio::datastream<Stream>& operator>> (ETAio::datastream<Stream>& ds, optional& op)
         {
            char valid = 0;
            ds >> valid;
            if (valid) {
         ...
         */
         template<typename Stream>
         friend inline ETAio::datastream<Stream>& operator<< (ETAio::datastream<Stream>& ds, const optional& op)
         {
