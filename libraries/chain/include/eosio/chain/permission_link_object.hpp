...
CHAINBASE_SET_INDEX_TYPE(ETAio::chain::permission_link_object, ETAio::chain::permission_link_index)

FC_REFLECT(ETAio::chain::permission_link_object, (id)(account)(code)(message_type)(required_permission))
