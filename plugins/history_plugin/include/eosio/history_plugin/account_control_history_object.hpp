...
CHAINBASE_SET_INDEX_TYPE( ETAio::account_control_history_object, ETAio::account_control_history_multi_index )

FC_REFLECT( ETAio::account_control_history_object, (controlled_account)(controlled_permission)(controlling_account) )
