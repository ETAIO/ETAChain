...
#include <ETAio/chain/multi_index_includes.hpp>
...
CHAINBASE_SET_INDEX_TYPE(ETAio::chain::table_id_object, ETAio::chain::table_id_multi_index)
CHAINBASE_SET_INDEX_TYPE(ETAio::chain::key_value_object, ETAio::chain::key_value_index)

CHAINBASE_SET_INDEX_TYPE(ETAio::chain::index64_object, ETAio::chain::index64_index)
CHAINBASE_SET_INDEX_TYPE(ETAio::chain::index128_object, ETAio::chain::index128_index)
CHAINBASE_SET_INDEX_TYPE(ETAio::chain::index256_object, ETAio::chain::index256_index)
CHAINBASE_SET_INDEX_TYPE(ETAio::chain::index_double_object, ETAio::chain::index_double_index)
CHAINBASE_SET_INDEX_TYPE(ETAio::chain::index_long_double_object, ETAio::chain::index_long_double_index)

FC_REFLECT(ETAio::chain::table_id_object, (id)(code)(scope)(table) )
FC_REFLECT(ETAio::chain::key_value_object, (id)(t_id)(primary_key)(value)(payer) )
