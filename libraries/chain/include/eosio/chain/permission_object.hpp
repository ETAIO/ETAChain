...
CHAINBASE_SET_INDEX_TYPE(ETAio::chain::permission_object, ETAio::chain::permission_index)
CHAINBASE_SET_INDEX_TYPE(ETAio::chain::permission_usage_object, ETAio::chain::permission_usage_index)

FC_REFLECT(chainbase::oid<ETAio::chain::permission_object>, (_id))
FC_REFLECT(ETAio::chain::permission_object, (id)(usage_id)(parent)(owner)(name)(last_updated)(auth))

FC_REFLECT(chainbase::oid<ETAio::chain::permission_usage_object>, (_id))
FC_REFLECT(ETAio::chain::permission_usage_object, (id)(last_used))
