...
namespace ETAio {
   ...
   struct margin_state {
      ...
      extended_asset unlend( double ishares ) {
         ...
         ETAio_assert( interest_shares >= 0, "underflow" );
         ETAio_assert( total_lendable.amount >= 0, "underflow" );

         return result;
      }

      ETALIB_SERIALIZE( margin_state, (total_lendable)(total_lent)(least_collateralized)(interest_shares) )
   };
   ...
   struct exchange_state {
      ...
      struct connector {
         ...
         ETALIB_SERIALIZE( connector, (balance)(weight)(peer_margin) )
      };
      ...
      ETALIB_SERIALIZE( exchange_state, (manager)(supply)(fee)(base)(quote) )
   };

   typedef ETAio::multi_index<N(markets), exchange_state> markets;
