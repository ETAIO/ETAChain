...
class Utils:
    ...
    ETAClientPath="programs/clETA/clETA"

    ETAWalletName="kETAd"
    ETAWalletPath="programs/kETAd/"+ ETAWalletName

    ETAServerName="nodETA"
    ETAServerPath="programs/nodETA/"+ ETAServerName

    ETALauncherPath="programs/ETAio-launcher/ETAio-launcher"
    MongoPath="mongo"
    ShuttingDown=False
