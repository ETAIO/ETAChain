...
namespace  ETAio {
    ...
    *  @brief Defines ETAIO Singleton Table
    *  @ingroup databasecpp 
    *  @{
    */
   ...
   class singleton
   {
      ...
      struct row {
         ...
         ETALIB_SERIALIZE( row, (value) )
      };

      typedef ETAio::multi_index<SingletonName, row> table;
      ...
      public:
         ...
         T get() {
            ...
            ETAio_assert( itr != _t.end(), "singleton does not exist" );
            return itr->value;
         }
